...
{
	// TODO
	ContractCompiler runtimeCompiler(nullptr, m_runtimeContext, m_optimiserSettings, RevertStrings::Default);
	...
	// TODO
	ContractCompiler creationCompiler(&runtimeCompiler, m_context, creationSettings, RevertStrings::Default);
